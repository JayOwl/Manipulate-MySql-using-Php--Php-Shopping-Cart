...
const DB_USER		= "gabecugelman";	//assign valid credentials here
const DB_PASS		= "a5e82ce80D";	//assign valid credentials here
const DB_NAME		= "bcit";
/* 
-- IMPORTANT --
all PHP scripts in SSD that use databases MUST
